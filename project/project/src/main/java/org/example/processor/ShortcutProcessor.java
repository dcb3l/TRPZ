...
public class ShortcutProcessor implements FileProcessor {
  ...
  private void createShortcut(String targetPath, String shortcutName) throws Exception {
    ...
    String oneDriveDesktop = userHome + "/OneDrive/Desktop/";
    String classicDesktop = userHome + "/Desktop/";
    String desktopPath;
    if (new java.io.File(oneDriveDesktop).exists()) {
      desktopPath = oneDriveDesktop + shortcutName + ".lnk";
    } else {
      desktopPath = classicDesktop + shortcutName + ".lnk";
    }
